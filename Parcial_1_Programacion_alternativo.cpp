/*INGRESE NUMEROS ENTEROS EN UN ARREGLO, PARA FINALIZAR LA CARGA DEBE PRESIONAR 0 (CERO). 
LLENAR UN SEGUNDO ARREGLO CON LOS NUMEROS POSITIVOS 
Y UN TERCER ARREGLO CON LOS NUMEROS NEGATIVOS
LUEGO, MOSTRAR LOS 3 ARREGLOS. */
